...
class HashProbeWordList:
    """
    Class used to generate a list of potential passwords based on personal info.
    """
    ...
    def generate_smart_wordlist():
        ...
        final_list = HashProbeWordList.create_smart_wordlist_data(
            name, nickname, birth, extra
        )
